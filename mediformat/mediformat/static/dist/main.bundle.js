...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<app-header>\n\n</app-header><div style=\"text-align:center\">\n  <h1>\n    <app-test></app-test>\n  </h1>\n</div>\n\n"
...
var networkInterface = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_apollo_client__["a" /* createNetworkInterface */])({
...
var client = new __WEBPACK_IMPORTED_MODULE_3_apollo_client__["b" /* ApolloClient */]({
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4_apollo_angular__["a" /* ApolloModule */].forRoot(provideClient),
...
var TestComponent = (function () {
    function TestComponent(apollo) {
        this.apollo = apollo;
        this.name = "Hund";
        this.description = "Franz";
        this.disease = "FRANZZ";
    }
    TestComponent.prototype.ngOnInit = function () {
        ...
        this.apollo.watchQuery({
            ...
            var data = _a.data;
            _this.name = data.symptom.name;
            _this.description = data.symptom.description;
            _this.disease = data.symptom.associateddiseases.edges[0].node.id;
        });
    };
